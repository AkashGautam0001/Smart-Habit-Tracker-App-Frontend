...
export default function DailyReviewCard({ date }: Props) {
  ...
  return (
    <Card className="border-primary/25 bg-gradient-to-br from-primary/8 to-[#8b5cf6]/6">
      <CardHeader className="pb-0">
        <div className="flex size-8 items-center justify-center rounded-lg bg-primary/15 text-primary">
          <RobotIcon size={18} weight="duotone" />
        </div>
        <CardTitle className="text-[0.88rem]">AI Daily Review</CardTitle>
          ...
          {state === 'idle' && (
            ...
            >
              <Button
                type="button"
                variant="outline"
                className="w-full border-primary/30 bg-primary/12 text-primary hover:bg-primary/20 hover:text-primary"
                onClick={generate}
              >
